#include <stdio.h>
/*
    This program will print increasing triangle using stars
*/
int main(){ // Main function
    ...
    for(row = 1; row <= size; row++){ // This for loop is responsible for printing rows pending on the size we have
        ...
        for(col = 1; col <= row; col++){ // This for loop is responsible for printing cols pending on the size we have
